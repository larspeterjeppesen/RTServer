...
static content: &'static str = "
    aIR of authoRItY
Prerequisites: Fellowship 30The Explorer was born to command, either motivating or terrifying those under his charge. On a successful Command Test, the Explorer may affect a number of targets equal to 1d10 plus his Fellowship Bonus. This talent has no effect on hostile targets, and only affects NPCs.

amBIdeXtRous
Prerequisites: Agility 30This Talent does not represent true ambidexterity so much as sufficient training with both hands to make the distinction moot. The Explorer can use either hand equally well for any task, and does not suffer the –20 penalty for actions using his off hand.Special: When combined with a Two-Weapon Wielder Talent, the penalty for making attacks with both weapons in the same Turn drops to –10.

aRmouR of coNtemPt
Prerequisites: Willpower 40The Explorer’s hatred of all the impure armours his soul against malign influence. Whenever the Explorer gains Corruption Points, reduce the total by 1, to a minimum of 0.With a successful Willpower Test, taken as a Free Action,he may ignore the effects of accumulated Corruption Pointsfor 1 Round.

assassIN stRIke
Prerequisites: Agility 40, AcrobaticsThe Explorer’s natural agility and graceful martial forms turn him into a dervish of death on the battlefield. After making a melee attack, a successful Acrobatics Test allows him to move at half rate as a Free Action. The Explorer’s opponent does not receive a free attack resulting from this move. He may only take this additional move once per Round.
...
Prerequisites: Psy Rating, Strong Minded, Will Power 40The Explorer’s sheer willpower and psychic focus have become one and the same over years of practice and training, such that their combined use is second nature. He doubles his defensive Psy Rating on any Opposed Test involving the Psyniscience Skill or Psychic Techniques.

Battle Rage
Prerequisites: Frenzy TalentLong experience and indomitable will have allowed the Explorer to master the beast within, directing its rage while keeping a level head. He can Parry while Frenzied.
...
BlademasteR
Prerequisites: Weapon Skill 30, Melee Weapon TrainingThe Explorer’s mastery of bladed weapons and their martial disciplines has no peer. When attacking with any bladed weapon, including chain weapons, power axes, and power swords, he may re-roll one missed attack per Round.

959595959595959595IVIVIV::: Talents Talents TalentsBlessed RadIaNce
Prerequisites: Purge the Unclean, Divine Ministration, the Emperor Protects, or Wrath of the RighteousThe Explorer’s holiness shines out, allowing all to see the truth of their own souls. Where he treads, those who follow need have no fear of the darkness, nor suffer the predations of the blasphemous.When spending a Fate Point to activate the Pure Faith Talent, the Explorer extends the immunity to daemonic presence to a number of targets equal to twice his Willpower Bonus.As a free action, he may bestow a single Fate Point to an ally. If the Fate Point is unspent, it returns at the end of the encounter.Upon burning a Fate Point, the Explorer and a number of allies equal to twice his Willpower Bonus become immune to the effects of daemonic presence, Fear Tests, and Corruption Points. In addition, all affected targets gain a +10 bonus on Tests made to resist psychic attack or any other form of psychic manipulation. In addition, affected targets take only half Damage from psychic and warp sources. These benefits last for the duration of the encounter.

BlINd fIghtINg
Prerequisites: Perception 30Years of practice and development of the Explorer’s other senses allows him to fight in close combat without the benefit of sight. This Talent reduces all penalties for obscured vision by half, permitting the character to fight in fog, smoke, or darkness.
...
BulgINg BIcePsPrerequisites: Strength 45
...
cleaNse aNd PuRIfY
Prerequisites: Flame Weapons Training (Universal) TalentThe Explorer can control the flow of molten promethium like no other, manipulating flame like an old accomplice. The targets of his flamer attacks take a –20 penalty their Agility Tests to escape its effects.

comBat foRmatIoN
Prerequisites: Intelligence 40The Explorer has directed his comrades to be prepared for danger, planning out their actions for many contingencies if attacked. Before rolling initiative, all other members of the group may choose to use the character’s Intelligence Bonus for all initiative rolls rather than individual Agility Bonuses.

96IVIVIV::: Talents Talents TalentscomBat masteR
Prerequisites: Weapon Skill 30The Explorer’s weapon seems to be everywhere at once, keeping many more opponents at bay in close combat than even skilled fighters. Opponents gain no bonuses for outnumbering the character in hand-to-hand combat.

comBat seNse
Prerequisites: Perception 40The Explorer has the ability to consciously recognise the proddings of his subconscious as it reacts to his preternaturally sharp senses, giving the character an edge that mere speed cannot match. He can use his Perception Bonus in place of his Agility Bonus when rolling Initiative. 
...
couNteR attack
Prerequisites: Weapon Skill 40The Explorer’s lightning ripostes are things of beauty—if they were slow enough to be seen. After successfully Parrying an opponent’s attack, he may immediately make an attack against that opponent using the Parry weapon as a Free Action. This attack suffers a –20 penalty.

cRack shot
Prerequisites: Ballistic Skill 40The Explorer can place his shots where they will inflict more harm: at creases, gaps, or joints in armour. When his ranged attack causes Critical Damage, add +2 to the Damage.

cRIPPlINg stRIke
Prerequisites: Weapon Skill 50The Explorer can land blows precisely where they will inflict the most harm, cutting into seams or hammering at weak points. When the character’s melee attack causes Critical Damage, add +4 Damage.

cRushINg BloW
Prerequisites: Strength 40The Explorer has the ability to focus his entire body into close combat attacks., adding +2 to damage inflicted in melee.
...
deadeYe shot
Prerequisites: Ballistic Skill 30The Explorer’s rock-steady hand and hawk-like eyesight make him a dreaded marksman. No target, however precise, can escape his crosshairs. When making a called shot, the character takes a –10 penalty instead of –20.

decadeNce
Prerequisites: Toughness 30Through conditioning or long years of abuse, the Explorer has built up a tolerance to many inebriants, drugs, and chemicals. When drinking alcohol or similar beverages, he does not pass out until he has failed a number of Toughness Tests equal to twice his Toughness Bonus. The character also gains a +10 bonus to resist the effects of addiction.

dIe haRd
Prerequisites: Willpower 40Through either willpower or sheer stubbornness, the Explorer refuses to cross into shadow. When he suffers from blood loss, the character may roll twice to avoid death.

dIsaRm
Prerequisites: Agility 30The Explorer can wrest weapons from an opponent’s hands through practiced technique or brute force. If in close combat, he may use a Full Action to disarm his foe by making an Opposed Weapon Skill Test. If he wins the Test, the opponent drops his weapon at his feet. If the character scores three or more Degrees of Success, he takes his opponent’s weapon.
...
dual stRIke
Prerequisites: Agility 40, Two-Weapon Wielder (Melee)The Explorer’s skill with melee weapons can place two blows together to maximise damage. When armed with two melee weapons, he can attack with both simultaneously as a Full Action. Make a single Weapon Skill Test, and if successful, he hits the target with both weapons. As he is swinging both weapons as a single attack, the character may take an Aim Action before attacking to get a +10 or +20 bonus to the WS Test. He does not suffer from the normal –20 WS penalty for wielding two weapons. If he hits, the target’s Armour gets applied as normal to both hits individually, but Toughness only counts once against the combined Damage rolls of both hits. A single successful Dodge or Parry Test from the target will avoid both blows.

dutY uNto death
Prerequisites: Will Power 45The Explorer’s will or faith can sustain him when his flesh is weak. He ignores the effects of injury, Fatigue, and Stunning during combat. This Talent does not prevent the Damage, but allows the character to temporarily ignore its effects for the duration of the combat. Death still affects him normally.

electRIcal succouR 
Prerequisites: Mechanicus ImplantsThe Explorer can channel the sacred flow of energy from his Potentia Coil or other energy source to replenish his flesh. Whilst in contact with a functioning, powered machine, or fully charged battery or power cell, the character may make an Ordinary (+10) Toughness Test. Success removes one level of Fatigue plus one additional level of Fatigue for each additional Degree of Success. This takes one minute of meditation and ritual incantation.

electRo gRaft use 
Prerequisites: Mechanicus ImplantsThe Explorer may use his Electro Graft to access data ports and commune with machine spirits. This grants a +10 bonus to Common Lore, Inquiry, or Tech-Use Tests whilst connected to a data port.
...
eNeRgY cache 
Prerequisites: Mechanicus ImplantsThe Explorer has learned to focus the power stored within his Potentia Coil with greater efficiency. He no longer gains Fatigue from using Luminen Charge, Luminen Shock, and Luminen Blast.

98IVIVIV::: Talents Talents TalentseNhaNced BIoNIc fRame
Prerequisites: Machinator ArrayThe Explorer’s already impressive bionic body structure is steadied by a gyro-array guided by a targeting system linked to the machine-spirit. The Explorer gains the Auto-stablilised Trait (see page 364).
...
Prerequisite: Willpower 35Whenever a Focus Power Test results in Psychic Phenomena, the Explorer may roll twice on that table and take the more favourable result.
...
haRd taRgetPrerequisites: Agility 40
...
haRdY
Prerequisites: Toughness 40The Explorer’s constitution rebounds quickly from shock or injury. When undergoing medical treatment or healing from injures, he recovers Damage as if Lightly Wounded.
...
100IVIVIV::: Talents Talents TalentsheIghteNed seNses
...
hIP shootINg
Prerequisites: Ballistic Skill 40, Agility 40The Explorer’s prowess with ranged weapons is such that he can still fire accurately without using the sights. As a Full Action, the character may both move up to his Full Move rate and make a single attack with a ranged weapon. This attack can only be a single shot—no automatic fire.

hotshot PIlot
Prerequisites: Any Pilot Skill, Agility 40The Explorer can pilot vehicles as if they were extensions of his own body. He may only select this Talent if he has obtained one Pilot Skill as an Advanced Skill. The character treats all other Pilot skills as Basic Skills, and receives a +10 bonus to the Pilot Skills he already possesses.

INfused kNoWledge
Prerequisites: Intelligence 40The Explorer has been infused with a great wealth of lore and knowledge, either through punishing noetic techniques or by arcane methods kept secret by the guardians of technology and knowledge. The Explorer treats all Common and Scholastic Lore Skills as untrained Basic Skills. This Talent also provides a +10 bonus to any Tests involving Common or Scholastic Lore for which he already possesses the Skill.

ImPRoVed WaRP seNse
Prerequisites: Warp SenseThe Explorer can now see the warp and physical universe side by side, no longer taking any concentration on his part. After gaining this Talent, the character may use the Psyniscience Skill as a Free Action.

INdePeNdeNt taRgetINg
Prerequisites: Ballistic Skill 40The Explorer has developed his peripheral vision and situational awareness to a point where he can fire in two directions within a split second. When firing two weapons as part of a single action, the targets need not be less than 10 metres apart.

INto the jaWs of hell
Prerequisites: Iron DisciplineThe Explorer inspires loyalty and devotion in his followers such that they would follow him into the warp or on a boarding action against xeno corsairs. In personal combat, while visible to them, they are immune to Fear and Pinning. While the character is known to be on board a ship in which he serves, the ship has a +5 bonus to its Morale.

INsPIRe WRath
Prerequisites: Fellowship 30The Explorer knows just the turn of phrase that incites individuals or groups to rage against others. His rhetoric grants +20 to Interaction Tests when inspiring hatred or anger, anddouble the number of individuals affected. This Talent can becombined with Master Orator to further increase the numberof listeners affected.

IRoN dIscIPlINe
Prerequisites: Willpower 30, CommandIron sharpens iron. The Explorer does not coddle his crew, nor motivate them through kindness. His stalwart example and stern leadership exhorts them with steel instead of spoils. If the character is visible to his followers, either in person or via vox- or pict-caster, they may re-roll failed Willpower Tests made to resist Fear and Pinning. Iron Discipline can affect a number of targets equal to the character’s Willpower Bonus, who must be under his command. PCs can benefit from Iron Discipline if the character with this Talent is the official group leader. If the Explorer is leading a boarding action (see page 215), he gains a +10 bonus to his Command Tests.

IRoN jaW
Prerequisites: Toughness 40The Explorer has taken blows from Orks and given back as good as he got. He can bounce back from most strikes without ill effects. If ever Stunned, a successful Toughness Test allows him to ignore the effects.

jaded
Prerequisites: Willpower 30The Explorer’s wide travels have shown both wonders and horrors beyond the ken of most. The galaxy has thrown its worst at him and he has yet to flinch. Outrageous events, from death’s horrific visage to xenos abominations, will not cause Insanity Points or Fear Tests. Terrors of the Warp still affect the character normally.

leaP uP
Prerequisites: Agility 30A combination of athletic ability and speed allow the Explorer to spring to his feet in virtually any circumstance. He may stand up as a Free Action.

101IVIVIV::: Talents Talents Talentslast maN staNdINg
Prerequisites: Nerves of SteelThe Explorer has developed a sixth sense about hails of gunfire, allowing him to sense gaps and pauses in the lethal rain. He is immune to Pinning by Pistols and Basic Weapons, and adds +1 AP to the value of any cover protecting him from ranged attacks.

lIght sleePeR
Prerequisites: Perception 30The slightest change in conditions or disturbance brings the Explorer from sleep to full awareness, remaining alert even in slumber. He is always assumed to be awake, even when asleep, for the purposes of Awareness Tests or surprise. Unfortunately, the character’s sleep is not deep and can be frequently interrupted, resulting in a less-than-cheery disposition when awake.

lIghtNINg attack
Prerequisites: Swift AttackThe Explorer’s speed with weapons is legendary, allowing him to launch flurries of attacks. As a Full Action, the character may make three melee attacks on his Turn. The effects of this Talent replace those of Swift Attack rather than adding to them. The use of Lightning Attack may not be combined with Dual Strike. If the Explorer has the Two-Weapon Wielder Talent and is wielding two melee weapons, he gets the advantage of Lightning Attack with only one of the weapons, and a single attack with the other. If he has the Two-Weapon Wielder Talent and is wielding a melee weapon in one hand and a gun in the other, he gets the advantage of Lightning Attack with the melee weapon and a single attack with the gun.
...
lItaNY of hate
Prerequisites: Hatred (any)The Explorer’s belief in the righteousness of his hatred is so ingrained that he can rouse others to join his crusade. As a Full Action, the character may make a Charm Test to extend the effects of his Hatred Talent to any allies in the immediate vicinity. Success on the Test confers a +10 bonus to Weapon Skill when fighting hated foes to one target per point of the Explorer’s Fellowship Bonus. The effects last for the duration of the encounter. 
...
lumINeN Blast
Prerequisites: Mechanicus ImplantsThe Omnissiah has blessed the Explorer with augmetic conduits that parallel the bones of his arms. By reciting the proper litany, he can channel the energy stored in his Potentia Coil down these channels and direct it at his enemies. Success on a Ballistic Skill Test allows him direct this energy against a single target within 10 meters. The target takes 1d10 plus the Explorer’s Willpower Bonus in Energy Damage. The character must pass a Toughness Test when using this ability or gain a level of Fatigue.Talent Use: Half Action Attack

lumINeN chaRge 
Prerequisites: Mechanicus ImplantsThe Explorer has mastered the union between his holy mechanical elements and his mortal flesh, allowing the former to power the latter. With a successful Toughness Test the character may recharge or power machinery with his internal coils. This requires one minute of meditation and ritual incantation. The difficulty of the Toughness Test varies depending on the nature of the powered system:The Explorer must pass a Toughness Test when he uses this ability or gain a level of Fatigue. No matter the power bestowed by the Omnissiah, some systems are either too large or too alien for this Talent—the GM will be the final judge.

lumINeN shock 
Prerequisites: Mechanicus ImplantsThe power of the Explorer’s Potentia Coil flows through a network of inductors within his flesh, allowing him to channel this energy into his blows. In close combat, a successful Weapon Skill Test or Grapple delivers the shock. The Luminen Shock inflicts 1d10+3 points of Energy Damage with the Shocking DifficultyExample

Ordinary (+10)Simple Power Cell, IlluminatorChallenging (+0)Weapon Charge Pack, Data Slate, Bridge TerminalDifficult (–10)Hotshot Charge Pack, Shuttle Electronics, Servo-SkullHard (–20)Lascannon Charge Pack, Servitor, Bridge HololithVery Hard (–30)Ship’s Cogitator Core, Reactor Machine Spirit, Xenos Tech102IVIVIVIVIVIVIVIV:::::::: Talents Talents Talents Talents Talents Talents Talents Talents
...
mIghtY shot
Prerequisites: Ballistic Skill 40The Explorer knows the weak points in every armour and material, and has the skill to place shots exactly where they will do the most damage. He adds +2 to Damage with a ranged weapon.
...
NaVIgatoR PoWeR
Prerequisites: NavigatorThe Explorer’s trainers or natural ability allows use of an additional Navigator Power. This Talent may be chosen multiple times, each selection granting a new Power.
...
PolYglotPrerequisites: Intelligence 40, Fel 30
...
PsYchIc techNIque
Talent Groups: See Psychic TechniquesEither through training or natural development, the Explorer has learned an additional Psychic Technique. Once this Talent has been selected, the Explorer may select one new Psychic Technique in any Discipline he possesses with an 

xp 
cost equal to or lower than the Talent’s 

xp 
cost. Note that when a Psychic Technique is selected, the Explorer does not have to spend more 

xp
–he spent the required 

xp 
when he purchased the Talent. This Talent may be chosen multiple times, each selection granting an additional Technique.
...
RaPId ReactIoN
Prerequisites: Agility 40The Explorer has honed his reactions to a razor’s edge, allowing him to act while most stand dumbfounded. When surprised or ambushed, a successful Agility Test allows him to act normally.
...
RIte of aWe
Prerequisites: ExploratorThe Omnissiah has augmetically blessed the Explorer’s voice box, allowing him to recite infrasonic liturgies that trigger awe and fear. All humans, regardless of their ability to hear, within a 50-metre radius feel a sense of dread and take a –10 penalty to their next Skill Test. Characters may ignore these effects with a successful Willpower Test. Whilst incanting the rite, the character may not talk or communicate with others. The rite requires two minutes of litanies, and it is considered very bad form to break off the recitation before completion. Humans without auditory implants cannot hear infrasonic sound, and though still affected, will not know the Explorer is speaking.

RIte of feaRPrerequisites: Explorator
...
shaRPshooteR
Prerequisites: Ballistic Skill 40, Deadeye ShotThe Explorer’s steady hand and eagle eye allow him to place shots exactly where he wants. When making a called shot, he does not incur the normal –20 penalty. This Talent replaces the effects of Deadeye Shot.
...
107IVIVIVIVIVIVIVIV:::::::: Talents Talents Talents Talents Talents Talents Talents TalentstakedoWN
...
total Recall
Prerequisites: Intelligence 30Mental conditioning or augmetics enable the Explorer to record and recall great amounts of information, effectively granting him a perfect memory. He can automatically remember trivial facts or pieces of information that might feasibly have picked up in the past. When dealing with more detailed, complex, or obscure facts, such as the deck plans of a space hulk or a complex xeno pictograph, the GM may require an Intelligence Test.

tRue gRIt
Prerequisites: Toughness 40The Explorer is able to shrug off wounds that would fell lesser men. Whenever he suffers Critical Damage, halve the result (rounding up).

tWo-WeaPoN WIeldeR
Talent Groups: Ballistic, Melee Prerequisites: Ballistic Skill 35 or Weapon Skill 35, Agility 35Years of training allow the Explorer to use a weapon in each hand when needed. When armed with two weapons of the same type, he may spend a Full Action to attack with both. Both tests made to attack with the weapons suffer a –20 penalty (see Chapter IX: Playing the Game for moredetails on fighting with two weapons). He must possess Two-Weapon Wielder (Melee) and Two-Weapon Wielder (Ballistic)if he wishes to use a gun and hand weapon with this Talent.

uNaRmed masteR
Prerequisites: Weapon Skill 45, Agility 40, Unarmed WarriorThe Explorer has developed unequalled mastery of unarmed combat techniques. His unarmed combat attacks do 1d10+SB (I)Damage and his attacks no longer have the Primitivequality.

uNaRmed WaRRIoR
Prerequisites: Weapons Skill 35, Agility 35Due to extensive training in unarmed combat, the Explorer’s unarmed combat attacks do 1d10-3 (+SB) Damage instead of 1d5-3. Because 

108108108108108108108108IVIVIVIVIVIVIVIV:::::::: Talents Talents Talents Talents Talents Talents Talents Talents
of his advanced training against both armed and unarmed foes, he does not count as Unarmed, as defined on page 245, when making attacks against armed opponents. The character’s attacks still count as having the Primitive quality.
...
VoId tactIcIaNPrerequisites: Intelligence 35
...
Wall of steel
Prerequisites: Agility 35The Explorer’s skill with blades is so profound that the merest hint of attack allows him to assume a defensive position. He may make one additional Parry per Round, in effect granting a second Reaction that may only be used to Parry. He may only attempt a single Parry against any one attack.

WaRP affINItY
Prerequisites: Psy RatingThe Explorer has a special connection to the warp, allowing him to occasionally sense and avoid its less desirable effects as he channels its power. The character may not select this Talent if he has undergone the Rite of Sanctioning. When rolling for Psychic Phenomenon, the Explorer may discard the die roll, suffer 1d5 Corruption Points, and then re-roll with no modifiers.

WaRP coNduIt
Prerequisites: Psy Rating, Strong Minded, Willpower 50The sheer power of the Explorer’s mind allows him to channel much more warp energy than his peers. When pushing, he may add a +1 bonus to his Psy Rating and subtract –10 on any resultant Psychic Phenomenon rolls.

WaRP seNse
Prerequisites: Navigator or Psy Rating, Psyniscience Skill, Perception 30The Explorer’s senses have evolved to perceive the warp in parallel with the physical world, though it requires some concentration to do so. After gaining this Talent, using the Psyniscience Skill requires a Half Action instead of a Full Action.

WhIsPeRs
Prerequisites: Intelligence 45, Fellowship 35Such is the Explorer’s reputation for having ears everywhere aboard the ship and a finely tuned network of invisible informants that the crew no longer even bothers to keep secrets from him. The Explorer receives a +10 bonus to any Skill Test for Investigation or the Interview special use of the Inquiry Skill.

WRath of the RIghteous
Prerequisites: Pure FaithThe Explorer is a killing angel, and he visits the Emperor’s righteous fury on those who deny His dominion over the stars, or who profane that which is sacred.When making an attack, the Explorer may spend a Fate Point to deal an additional 1d5 points of Damage.At any time while the Explorer is attacking, he may burn a Fate Point to trigger Righteous Fury on a single successful attack. The attack automatically deals the maximum Damage for the weapon plus 1d10 points of Damage. If the second roll results in 10, further Damage is possible (see Righteous Fury on page 245). 
";
